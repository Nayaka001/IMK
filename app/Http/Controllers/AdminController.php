...
class AdminController extends Controller
{
    ...
    public function laporan(){
        ...
        $totalDailyExpense = Pengeluaran::whereBetween('waktu_pengeluaran', [now()->startOfDay(), now()->endOfDay()])->sum('pengeluaran');
    $totalWeeklyExpense = Pengeluaran::whereBetween('waktu_pengeluaran', [now()->startOfWeek(), now()->endOfWeek()])->sum('pengeluaran');
    $totalMonthlyExpense = Pengeluaran::whereBetween('waktu_pengeluaran', [now()->startOfMonth(), now()->endOfMonth()])->sum('pengeluaran');
    ...
    $totalMonthlyExpense = Pengeluaran::whereBetween('waktu_pengeluaran', [now()->startOfMonth(), now()->endOfMonth()])->sum('pengeluaran');
        ...
        return view('admin.cetak-laporan-pengeluaran',[
            'laporan' => $laporan,
            'minggu' => $minggu,
            'bulan' => $bulan,
            'daily' => $daily,
