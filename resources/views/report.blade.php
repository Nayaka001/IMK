                                ...
                                <div class="p-4 md:p-5 space-y-4">
                                    {{-- <form class="space-y-4" action=""> --}}
                                        <div>
                                            ...
                                            <input type="text" name="text" id="text" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" placeholder="Nama Pengeluaran" name="nama_pengeluaran" />
                                        </div>
                                        <div>
                                            <label for="date" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tanggal dan Waktu</label>
                                            <input type="date" id="date" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white" name="waktu_pengeluaran"/>
                                        </div>
                                        <div>
                            ...
                            <tbody class="divide-y divide-white">
                                ...
                                <tr class="bg-[#f5f5e6]">
                                    ...
                                    <td class="px-3 pr-6 py-2 rounded-l-xl">
                                        <h1 class="text-black">001</h1>
                                    </td>
                                    {{-- Pelanggan --}}
                                    <td class="px-6 py-2">
                                        <h1 class="text-black">Fildza</h1>
                                    </td>
                                    {{-- Kasir --}}
                                    <td class="px-6 py-2">
                                        <h1 class="text-black">Sadtria</h1>
                                    </td>
                                    {{-- detail --}}
