                ...
                <div class="px-2 py-2 flex justify-between">
                    <div>
                        ...
                        <div class="flex py-1 items-center">
                            ...
                            <p class="text-lg ml-2">M01</p>
                        </div>
                        <h1 class="py-1 px-2 text-slate-400 text-base tracking-wide">4 item(s)</h1>
                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <div class="p-3 md:p-5 space-y-1 flex">
                                        <div class="w-full">
                                            ...
                                            <div class="w-20 text-center bg-green-500 text-white rounded-full p-2 tracking-wide my-2 font-semibold">Done</div>
                                        ...
                                        <div class="flex-col w-full">
                                            ...
                                            <div class="flex my-3">
                                                ...
                                                <div class="flex w-full justify-between">
                                                    ...
                                                    <div>
                                                        <h1 class="text-lg font-bold">Rp 15000</h1>
                                                        <div class="text-center w-fit p-1 px-2 bg-pink-300 rounded-full">Dimasak</div>
                                                    </div>
                                                </div>
                                            </div>
                                            {{-- end menu yang dipesan --}}
                                            ...
                                            <div class="flex my-3">
                                                ...
                                                <div class="flex w-full justify-between">
                                                    ...
                                                    <div>
                                                        <h1 class="text-lg font-bold">Rp 15000</h1>
                                                        <div class="text-center w-fit p-1 px-2 bg-[#ECCF98] rounded-full">Siap disajikan</div>
                                                    </div>
                                                </div>
                                            </div>
                                            {{-- end menu yang dipesan --}}
                    ...
                    <div class="flex items-center">
                        ...
                        <p class="text-3xl font-bold">001</p>
                    </div>
                </div>
            </div>
            {{-- end card --}}
