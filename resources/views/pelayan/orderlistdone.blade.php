...
<div class="flex overflow-x-hidden">
    ...
    <div class="w-full my-7 ml-24 sm:ml-36">
        ...
        <div class="w-full flex justify-around my-5">
            <a href="/pelayan-list">
                <div class="rounded-2xl w-36 md:w-64 lg:w-96 text-center px-3 py-2 shadow-md bg-white mx-2 font-bold text-lg text-blue-500 outline-2 outline-blue-500 ">Waiting</div>
            </a>
            <a href="/pelayan-list/done">
                <div class="rounded-2xl bg-green-500 w-36 md:w-64 lg:w-96 px-3 py-2 text-center shadow-md hover:bg-green-500 outline outline-2 outline-green-500 mx-2 font-bold text-white hover:text-white text-lg">Done</div>
            </a>
        </div>
                            ...
                            <div class="px-2 py-2 flex justify-between">
                                <div>
                                    ...
                                    <div class="flex py-1 items-center">
                                        ...
                                        <p class="text-lg ml-2">001</p>
                                    </div>
                                    <h1 class="py-1 px-2 text-black font-bold text-xl tracking-wide"> 1x Steak Blackpepper</h1>
                                    <button data-modal-target="default-modal" data-modal-toggle="default-modal" type="button">
                                        <div class="flex items-center">
                                            <h1 class="py-1 pl-2 pr-1 text-[#55C2FF] text-lg">Details</h1>
                                                ...
                                                <div class="p-3 md:p-5 space-y-1 flex">
                                                    <div class="w-full">
                                                        <div class="flex items-center">
                                                            ...
                                                            <p class="text-lg ml-3">20 Mei 2024 12.08 PM</p>
                                                        </div>
                                                        <div class="flex items-center">
                                                            ...
                                                            <p class="text-lg ml-3">Sadtria</p>
                                                        </div>
                                                        <div class="flex items-center">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" class="size-8">
                                                                <path fill-rule="evenodd" clip-rule="evenodd" d="M8 7C8 5.93913 8.42143 4.92172 9.17157 4.17157C9.92172 3.42143 10.9391 3 12 3C13.0609 3 14.0783 3.42143 14.8284 4.17157C15.5786 4.92172 16 5.93913 16 7C16 8.06087 15.5786 9.07828 14.8284 9.82843C14.0783 10.5786 13.0609 11 12 11C10.9391 11 9.92172 10.5786 9.17157 9.82843C8.42143 9.07828 8 8.06087 8 7ZM8 13C6.67392 13 5.40215 13.5268 4.46447 14.4645C3.52678 15.4021 3 16.6739 3 18C3 18.7956 3.31607 19.5587 3.87868 20.1213C4.44129 20.6839 5.20435 21 6 21H18C18.7956 21 19.5587 20.6839 20.1213 20.1213C20.6839 19.5587 21 18.7956 21 18C21 16.6739 20.4732 15.4021 19.5355 14.4645C18.5979 13.5268 17.3261 13 16 13H8Z" fill="black"/>
                                                            </svg>
                                                            <p class="text-lg ml-3">Fildza</p>
                                                        </div>
                                                        <div class="flex items-center">
                                                            ...
                                                            <p class="text-lg ml-3">3 orang</p>
                                                        </div>
                                                        <div class="flex items-center">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none" class="size-8">
                                                            ...
                                                            <p class="text-lg ml-3">M01</p>
                                                        </div>
                                                        <h1 class=" px-2 text-slate-400 text-lg tracking-wide">4 item(s)</h1>
                                                        <div class="w-max text-center bg-green-500 text-white rounded-full p-2 tracking-wide my-2 font-semibold">Selesai diantar</div>
                                                        <div class="bg-[#EEEEEE] my-2 w-full sm:w-80 h-fit p-2 rounded-xl mt-5 mr-5">
                                                            <h1 class="font-bold text-lg">Notes</h1>
                                                            <div class="flex">
                                                                <p class="font-semibold text-base mr-3 w-1/2">Steak Blackpepper :</p>
                                                                <p class="text-base w-2/3">gak pakai sayur </p>                                                        
                                                            </div>
                                                    ...
                                                    <div class="flex-col w-full">
                                                        ...
                                                        <div class="flex my-3">
                                                            ...
                                                            <div class="flex w-full justify-between">
                                                                <div class="ml-3 w-1/2">
                                                                    <h1 class="text-lg font-semibold">Chicken Steak</h1>
                                                                    <div class="w-16 text-center bg-[#FFD369] rounded-full">1</div>
                                                                </div>
                                                                <div>
                                                                    <h1 class="text-lg font-bold">Rp 15000</h1>
                                                                    <div class="text-center w-fit p-1 px-2 bg-green-300 rounded-full">Kosongkan Meja</div>
                                                                </div>
                                                        ...
                                                        <div class="w-full mt-6">
                                                            <button id="availableModalBtn" class="bg-yellow-400 text-white px-4 py-2 rounded-3xl w-full">Selesai</button>
                                                        </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        const selesaiBtn = document.getElementById('availableModalBtn');
        ...
        // Event listener untuk tombol "Close" pada modal konfirmasi
        ...
        confirmSaveBtn.addEventListener('click', function () {
            // Lakukan aksi yang diperlukan saat konfirmasi diterima
            hideModal(confirmModal);
        ...
        $('.details-button').on('click', function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    response.detailorder.forEach(menu => {
                        ...
                        <div class=" flex my-3">
                            <div>
                                <img src="https://source.unsplash.com/110x110" alt="" class="rounded-xl object-cover hidden sm:flex">
                            </div>
                            <div class="flex w-full justify-between">
                                <div class="ml-3 w-1/2">
                                    <h1 class="text-lg font-semibold">Steak</h1>
                                    <div class="w-16 text-center bg-[#FFD369] rounded-full">${menu.jumlah}</div>
                                </div>
                                <div>
                                    <h1 class="text-lg font-bold">Rp ${menu.subtotal}</h1>
                                    <div class="text-center w-fit p-1 px-2 bg-green-300 rounded-full">${menu.progress}</div>
                                </div>
                            </div>
                        </div>
                        `;
                    ...
                    //     noteItem.innerHTML = `
                    //     <p class="font-semibold text-base mr-3 w-1/2">Steak}</p>
