            ...
            <div class="text-white px-5 md:w-1/2">
                ...
                <form action="{{route('login.login')}}" method="POST">
                    ...
                    <label for="username" class="mx-10">
                        ...
                        <input type="text" name="username" id="username" placeholder="masukkan username" class="px-3 py-2 border shadow rounded w-full block text-sm placeholder:text-slate-400 text-black focus:outline-none focus:ring-1 focus:ring-sky-500 focus:border-sky-500 " />
                        <p class="pt-1 text-xs"></p>
                    </label>
                    <label for="password">
                        <span class="block font-semibold mb-1 after:content-['*'] after:text-pink-500 after:ml-0.5">Password</span>
                        <input type="password" name="password" id="password" placeholder="masukkan password" class="px-3 py-2 border shadow rounded w-full block text-sm text-black placeholder:text-slate-400 focus:outline-none focus:ring-1 focus:ring-sky-500 focus:border-sky-500" />
                         <p id="username" class="pt-1 text-xs text-slate-100"></p>
                    </label>
