...
<div class="w-full px-6 mx-auto">
        <div class="relative flex items-center p-0 mt-6 overflow-hidden bg-center bg-cover min-h-75 rounded-2xl" style="background-image: url('/img/logo.jpg'); background-position-y: 50%">
          <span class="absolute inset-y-0 w-full h-full bg-center bg-cover bg-gradient-to-b from-[#FFD369] to-[#cfdbd5] opacity-60"></span>
        </div>
        <div class="relative flex flex-col flex-auto min-w-0 p-4 mx-6 -mt-16 overflow-hidden break-words border-0 shadow-blur rounded-2xl bg-white/80 bg-clip-border backdrop-blur-2xl backdrop-saturate-200">
          <div class="flex flex-wrap -mx-3">
            <div class="flex-none w-auto max-w-full px-3">
              <div class="text-base ease-soft-in-out h-18.5 w-18.5 relative inline-flex items-center justify-center rounded-xl text-white transition-all duration-200">
                <img src="/img/logo.jpg" alt="profile_image" class="w-full shadow-soft-sm rounded-xl" />
              </div>
            </div>
            <div class="flex-none w-auto max-w-full px-3 my-auto">
              <div class="h-full">
                <h5 class="mb-1">Home Steak Annisa</h5>
                <p class="mb-0 font-semibold leading-normal text-sm">Home Made Steak Restaurant</p>
              </div>
            </div>
      ...
      <div class="w-full p-6 mx-auto">
        <div class="flex flex-wrap -mx-3">
          ...
          <div class="w-full max-w-full px-3 lg-max:mt-6 xl:w-4/12">
            <div class="relative flex flex-col h-full min-w-0 break-words bg-[#e8eddf] border-0 shadow-soft-xl rounded-2xl bg-clip-border">
              <div class="p-4 pb-0 mb-0 bg-[#e8eddf] border-b-0 rounded-t-2xl">
                <div class="flex flex-wrap -mx-3">
              ...
              <div class="flex-auto p-4">
                <p class="leading-normal text-sm">Home Steak Annisa adalah restoran homemase steak yang mengkhususkan diri dalam menyajikan hidangan steak yang affordable, pelayanan yang ramah, dan suasana yang nyaman untuk menciptakan pengalaman kuliner yang tak terlupakan bagi setiap pelanggan. Berlokasi strategis di kota Medan, restoran ini menawarkan suasana yang nyaman.</p>
                <hr class="h-px my-6 bg-transparent bg-gradient-to-r from-transparent via-white to-transparent" />
                <ul class="flex flex-col pl-0 mb-0 rounded-lg">
                  <li class="relative block px-4 py-2 pt-0 pl-0 leading-normal bg-[#e8eddf] border-0 rounded-t-lg text-sm text-inherit"><strong class="text-slate-700">Nama Restaurant:</strong> &nbsp; Home Steak Annisa</li>
                  <li class="relative block px-4 py-2 pl-0 leading-normal bg-[#e8eddf] border-0 border-t-0 text-sm text-inherit"><strong class="text-slate-700">Telephone:</strong> &nbsp; (+62) 123 1234 123</li>
                  <li class="relative block px-4 py-2 pl-0 leading-normal bg-[#e8eddf] border-0 border-t-0 text-sm text-inherit"><strong class="text-slate-700">Email:</strong> &nbsp; homesteakannisa@gmail.com</li>
                  <li class="relative block px-4 py-2 pl-0 leading-normal bg-[#e8eddf] border-0 border-t-0 text-sm text-inherit"><strong class="text-slate-700">Location:</strong> &nbsp; Medan</li>
                  <li class="relative block px-4 py-2 pb-0 pl-0 bg-[#e8eddf] border-0 border-t-0 rounded-b-lg text-inherit">
