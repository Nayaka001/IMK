...
<div class="flex overflow-x-hidden">
    ...
    <div class="w-full my-7 ml-24 sm:ml-36">
        ...
        <div class="w-full flex justify-around my-5">
            <a href="/order-list">
                <div class="rounded-2xl bg-white  w-36 md:w-64 lg:w-96 text-center px-3 py-2 shadow-md hover:bg-blue-500 outline outline-2 outline-blue-500 mx-2 font-bold text-blue-500 hover:text-white text-lg">Waiting</div>
            </a>
            <a href="/order-list/done">
                <div class="rounded-2xl w-36 md:w-64 lg:w-96 px-3 py-2 text-center shadow-md bg-green-500 mx-2 font-bold text-white text-lg">Done</div>
            </a>
        </div>
