                ...
                <div class="bg-white fixed h-screen ml-auto w-2/3 pt-7 px-2 rounded-lg lg:w-96 md:w-2/3 overflow-y-auto lg:right-0">
                    ...
                    <div id="btn2" class="hidden">
                        <div class="flex gap-2">
                            ...
                            <button type="submit" id="kirimButton" data-modal-target="popup-modal-berhasil" data-modal-toggle="popup-modal-berhasil" class="bg-green-500 p-2 w-fit rounded-lg font-bold hover:text-white px-6 sm:w-60 md:w-[300px] lg:w-full my-4">Kirim</button>
