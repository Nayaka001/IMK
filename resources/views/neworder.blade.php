                ...
                <div class="bg-white fixed h-screen ml-auto w-2/3 pt-7 px-2 rounded-lg lg:w-96 md:w-2/3 overflow-y-auto lg:right-0">
                    ...
                    <div class="my-5 bg-[#EEEEEE] py-1 rounded-lg px-1 md:w-[300px] lg:w-full">
                        ...
                        <div class="flex my-2 items-center">
                            ...
                            @if (Session::get('tipe_order') === 'Bawa Pulang')
                                <p class="text-sm ml-0.5 md:text-base">-</p>
                            @else
                        ...
                        <div class="p-4 md:p-5">
                            ...
                            <ul class="mb-4 flex justify-between gap-3">
                                <li class="w-full">
                                    ...
                                    <label for="Tunai" class="inline-flex items-center justify-between w-full p-5 text-gray-900 bg-white border border-gray-200 rounded-lg cursor-pointer  peer-checked:border-[#FFD369] peer-checked:text-[#FFD369] peer-checked:font-semibold hover:text-gray-900 hover:bg-gray-100">
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow dark:bg-white">
                    <div class="p-4 md:p-5 text-center">
                        ...
                        <h3 id="confirmationText" class="mb-5 text-lg font-normal text-gray-400">Apakah anda yakin memilih metode pembayaran ..... ?</h3>
                        <button id="confirmOrderBtn" data-modal-hide="popup-modal-bayar" type="button" class="text-white bg-green-600 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300  font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                            Ya
                        </button>
                        <button data-modal-hide="popup-modal-bayar" type="button" class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-red-700 focus:z-10 focus:ring-4 focus:ring-gray-100 " data-modal-target="select-modal" data-modal-toggle="select-modal" data-modal-hide="popup-modal-bayar">
                            Tidak
                        </button>
                    </div>
                </div>
        ...
        <div id="popup-modal-berhasil" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
            <div class="relative p-4 w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow ">
                    <button type="button" class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center" data-modal-hide="popup-modal-berhasil">
                    ...
                    <div class="p-4 md:p-5 text-center">
                        ...
                        <h3 class="mb-5 text-lg font-normal text-gray-500  py-4">Berhasil terkirim ke kitchen & bartender</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="relative p-4 w-full max-w-md max-h-full">
                <div class="relative bg-white rounded-lg shadow dark:bg-white">
                    <div class="p-4 md:p-5 text-center">
                        ...
                        <button data-modal-hide="popup-modal-konfirmasi-pesan" type="button" class="py-2.5 px-5 ms-3 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-red-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-white dark:text-gray-900 dark:border-gray-200 dark:hover:text-red-700">Tidak</button>
                    </div>
                </div>
            </div>
        </div>
