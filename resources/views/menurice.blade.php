...
<div class="flex overflow-x-hidden">
        ...
        <div class="w-full my-7 ml-24 mr-7 sm:ml-36">
            ...
            <div class="w-3/4 flex justify-between my-5 overflow-x-scroll sm:w-4/5 md:w-11/12 lg:w-full lg:overflow-visible">
                ...
                <a href="/menu/rice">
                    <div class="rounded-2xl bg-[#FFD369] w-fit px-3 py-2 shadow-md mx-2 font-bold ">Rice Hotplate</div>
                </a>
                <a href="/menu/geprek">
            ...
            <div class="flex-none">
                <h1 class="text-3xl font-bold ml-3 pt-3">Rice Hotplate Original</h1>
            ...
            <<div class="flex-none">
                <h1 class="text-3xl font-bold ml-3 mt-3">Rice Hotplate Sambal Matah/Korek</h1>
                <hr class="mt-5 w-full mx-3">
            </div>
